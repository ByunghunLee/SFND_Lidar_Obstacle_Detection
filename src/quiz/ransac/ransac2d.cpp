...
int main ()
{
	...
	//std::unordered_set<int> inliers = Ransac(cloud, max_iteration, distance_tolerance);

	std::unordered_set<int> inliers = RansacPlane(cloud, max_iteration, distance_tolerance);
